...
const LoginPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="group flex w-full max-w-4xl h-auto md:h-[80%] rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:border-green-500 hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
        <div className="hidden md:block md:w-1/2 bg-cover bg-center" style={{ backgroundImage: 'url("/img/image.png")' }} />
