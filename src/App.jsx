...
function Layout() {
  ...
  const hideLayout = location.pathname.startsWith("/admin-dashboard") || location.pathname.startsWith("/LandDashboard") || location.pathname.startsWith("/LogIn") || location.pathname.startsWith("/SignUp");
